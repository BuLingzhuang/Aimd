...
public class ScreenShotListenManager {
    ...
    private ScreenShotListenManager(Context context) {
        ...
        if (sScreenRealSize == null) {
            ...
            if (sScreenRealSize != null) {
                Log.d("blz", "Screen Real Size: " + sScreenRealSize.x + " * " + sScreenRealSize.y);
            } else {
                Log.w("blz", "Get screen real size failed.");
            }
        }
    }
    ...
    private void handleMediaContentChange(Uri contentUri) {
        ...
        try {
            ...
            if (cursor == null) {
                Log.e("blz", "Deviant logic.");
                return;
            }
            if (!cursor.moveToFirst()) {
                Log.d("blz", "Cursor no data.");
                return;
            }
    ...
    private void handleMediaRowData(String data, long dateTaken, int width, int height) {
        if (checkScreenShot(data, dateTaken, width, height)) {
            Log.d("blz", "ScreenShot: path = " + data + "; size = " + width + " * " + height
                    + "; date = " + dateTaken);
            ...
            Log.e("blz", "Media content changed, but not screenshot: path = " + data
